		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" ><a href="<%=basePath %>Leaveword/leaveword_userFrontAdd.jsp">我要留言</a></li>
				</ul>
			  	<!-- Tab panes -->
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>留言标题</td><td>留言人</td><td>留言时间</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="leaveword_title_edit" class="col-md-3 text-right">留言标题:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="leaveword_title_edit" name="leaveword.title" class="form-control" placeholder="请输入留言标题">
			 </div>
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
		  	 ...
		  	 <div class="col-md-9">
			    <input type="text" id="leaveword_replyContent_edit" name="leaveword.replyContent" class="form-control" placeholder="请输入回复内容">
			 </div>
		  </div>
		  <div class="form-group">
